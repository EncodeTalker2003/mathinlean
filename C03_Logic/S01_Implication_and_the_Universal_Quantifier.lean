...
theorem my_lemma4 :
  ...
  calc
    ...
    _ ≤ |x| * ε := by
      apply mul_le_mul; apply le_refl; apply le_of_lt ylt; apply abs_nonneg; apply abs_nonneg
    _ < 1 * ε := by apply (mul_lt_mul_right epos).mpr; linarith
